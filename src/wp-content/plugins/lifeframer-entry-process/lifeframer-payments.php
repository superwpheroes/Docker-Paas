    ...
    if (!$my_errors->hasErrors()) {
        ...
        $result = Braintree\Transaction::sale([
            ...
            'billing' => [
                ...
                'streetAddress' => $_POST['billing-address-1'],
                'locality' => $_POST['billing-locality'],
                'postalCode' => $_POST['billing-postal-code']
            ],
            'options' => [
        ...
        if ($result->success) {
            ...
            wp_redirect($transaction->after_payment . '?transaction=' . $transaction_id.'&email='.base64_encode($email_address));
            exit();
        }
    }
...
//        $name .= !empty($_POST['lastName']) ? $_POST['lastName'] : '';
