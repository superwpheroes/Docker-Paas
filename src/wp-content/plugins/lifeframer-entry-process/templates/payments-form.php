...
<div class="sortable-loading register-loader" style="display:none;">
    <div class="register-loader-content">
        <h3 data-fontsize="30" data-lineheight="36px" class="fusion-responsive-typography-calculated" style="--fontSize:30; line-height: 1.2 !important;">We are processing your payment</h3>
        <div class="bubblingG">
                    <span id="bubblingG_1">
                    </span>
            <span id="bubblingG_2">
